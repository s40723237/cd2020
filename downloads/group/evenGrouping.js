...
(function dartProgram() {
  ...
  N = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new N.main_closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    grouping: function() {
      var t1 = {},
        t2 = $.$get$output();
      ...
      t1.gpList = [];
      t1.numList = [];
      W.HttpRequest_getString(t2).then$1$1(new N.grouping_closure(t1, [], "cd2020"), null);
    },
