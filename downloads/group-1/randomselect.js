...
(function dartProgram() {
  ...
  J = {
    ...
    shuffle$0$ax: function(receiver) {
  ...
  L = {
    main: function() {
      var t1 = J.get$onClick$x(document.querySelector("#Rsubmit")),
    ...
    randomSelect: function() {
      var t1 = $.$get$output();
      (t1 && C.TextAreaElement_methods).setInnerHtml$1(t1, "");
      t1 = $.$get$studListUrl().value;
      if (t1 !== "")
        $.grpList = t1;
      else
        $.grpList = "https://mde.tw/cd2020/downloads/2a_group_list.txt";
      t1 = $.$get$numOfStud().value;
      if (t1 !== "")
        $.num = P.int_parse(t1);
      else
        $.num = 2;
      W.HttpRequest_getString($.grpList).then$1$1(new L.randomSelect_closure(), null);
    },
    main_closure: function main_closure() {
    },
    randomSelect_closure: function randomSelect_closure() {
    }
  };
  ...
  L.main_closure.prototype = {
    call$1: function(e) {
      ...
      return L.randomSelect();
    },
    $signature: 21
  };
  L.randomSelect_closure.prototype = {
    call$1: function(resp) {
      var studList, t1, i, t2, i0, j;
      H.stringTypeCheck(resp);
      resp.toString;
      studList = H.listTypeCheck(C.C_JsonCodec.decode$2$reviver(0, H.stringReplaceAllUnchecked(resp, "'", ""), null));
      for (t1 = J.getInterceptor$asx(studList), i = 0; i < t1.get$length(studList); i = i0) {
        J.shuffle$0$ax(t1.$index(studList, i));
        t2 = $.$get$output();
        t2.textContent = J.$add$ns(t2.textContent, C.JSString_methods.$mul("-", 20) + "\n");
        i0 = i + 1;
        j = 0;
        while (true) {
          t2 = $.num;
          ...
          if (!(j < t2))
            break;
          t2 = $.$get$output();
          t2.textContent = J.$add$ns(t2.textContent, C.JSString_methods.$add("group " + i0 + ":", J.toString$0$(J.$index$asx(t1.$index(studList, i), j))) + "\n");
          ++j;
        }
      }
    },
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "studListUrl", "$get$studListUrl", function() {
      return H.interceptedTypeCheck(W.querySelector("#RstudListUrl"), "$isSelectElement");
    });
    _lazy($, "numOfStud", "$get$numOfStud", function() {
      return H.interceptedTypeCheck(W.querySelector("#RnumOfStud"), "$isInputElement");
    });
    _lazy($, "output", "$get$output", function() {
      return H.interceptedTypeCheck(W.querySelector("#Routput"), "$isTextAreaElement");
    });
  })();
...
//# sourceMappingURL=randomselect.js.map
